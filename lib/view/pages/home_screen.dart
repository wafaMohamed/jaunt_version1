...
import 'package:jaunt/view/pages/layout_screen.dart';
import 'package:jaunt/view/pages/search/search.dart';
...
class _HomePageScreenState extends State<HomePageScreen> {
              ...
              child: Column(
                children: [
                                  ...
                                  child: Container(
                                    ...
                                    decoration: BoxDecoration(
                                        ...
                                        image: DecorationImage(
                                          image:
                                             /* NetworkImage('https://www.figma.com/file/xqJlerMarS2sIgiy6J0h1P/UI8-Jobsque---Job-Finder-(Copy)?node-id=0%3A1&t=osecKJDDVsYZJkfj-0${layoutBottomNavigation.myPlaces[index].images!.first }'),*/
                                          AssetImage(
                  ...
                  ListView.builder(
                      ...
                      itemCount: layoutBottomNavigation.myPlaces.length,
                      shrinkWrap: true,
                      itemBuilder: (BuildContext context, int index) {
                        return Padding(
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Expanded(
                                        child: Text(
                                          layoutBottomNavigation.myPlaces[index].name!,
                                ...
                                Row(
                                  children: [
                                    ...
                                    Expanded(
                                      child: Text(
                                        layoutBottomNavigation.myPlaces[index].desc!,
                                        overflow: TextOverflow.ellipsis,
  ...
  _launchURL() async {
    var uri = Uri.parse("https://jauntbooking.onrender.com/admin/auth/sign-up");
