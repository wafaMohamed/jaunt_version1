...
import 'package:jaunt/model/user.dart';
                  ...
                  children: [
                    ...
                    CSCPicker(
                      onCountryChanged: (country) {
                        this.cuntry=cuntry??'egypt';
                      },
                      onCityChanged: (mCity) {
                        print('city:$mCity');
                        city=mCity??'New Cairo';
                      },
                      onStateChanged: (state) {
                        gaverment=state??'cairo';
                      },
                    ...
                    Container(
                      ...
                      child: TextButton(
                        onPressed: () {
                          print(formdkey1.currentState!.validate());
                          print(cuntry!=null);
                          print(city!=null);
                          print(gaverment!=null);
                          print(image!=null);

                          if (formdkey1.currentState!.validate()&&cuntry!=null&&city!=null&&gaverment!=null&&image!=null) {
                            formdkey1.currentState!.save();
                            setState(() {
                              currentStep = 2;
                            });
                          }
  ...
  Future<void> registerUser() async {
    ...
    try {
      ...
      await _auth.createUserWithEmailAndPassword(
        ...
        value.user!.updatePhotoURL(model.photo);
        value.user!.updateDisplayName(model.name);
      });

      Reference ref = FirebaseStorage.instance
          .ref()
          .child('users/${model.uid}');
